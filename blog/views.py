...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            subject = '%s (%s) Zachęca do przeczytania "%s"' % (cd['name'], cd['email'], post.title)
            message = 'Przeczytaj ' + post_url + '\n\n' + cd['comments']
...
def post_detail(request, year, month, day, post, new_comment=None):
